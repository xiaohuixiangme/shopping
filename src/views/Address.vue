    ...
    <div class="checkout-addr">
      ...
      <div class="check-step">
        <ul>
          ...
          <li><span>创建支付</span></li>
          <li><span>订单完成</span></li>
        </ul>
      </div>
          ...
          <ul>
            <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddrId=item.addressId">
              ...
              <div class="addr-opration addr-set-default">
                <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefault(item.addressId)"><i>设置默认</i></a>
              </div>
...
<modal v-bind:mdShow="isMdShow2" v-on:close="isMdShow2=false">
    <p slot="message">
